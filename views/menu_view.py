...
class MenuView(QWidget):
    def __init__(self):
        ...
        self.max_size_polyomino_label = QLabel("Max size:")
        self.max_size_polyomino = QComboBox()
        self.max_size_polyomino.addItems(["6","7","8","9"])
        ...
        center_layout.addWidget(self.max_size_polyomino_label, alignment=Qt.AlignCenter)
        center_layout.addWidget(self.max_size_polyomino, alignment=Qt.AlignCenter)
